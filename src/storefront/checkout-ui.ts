...
body.checkout-page{--paper:#fff;--ink:#1a1a1a;--raise:#f5f5f5;--muted:#626262;--line:#dedede;--primary:#1773b0;--button-label:#fff;--radius:6px;--body:Arial,Helvetica,sans-serif;--display:var(--body);--body-weight:400;background:#fff;color:#1a1a1a;font:400 14px/1.5 var(--body);color-scheme:light}
...
.checkout-page .co-logo img{max-width:200px;max-height:48px;width:auto;height:auto;object-fit:contain}
.checkout-page .co-cart-link{display:grid;place-items:center;width:44px;height:44px;color:#1773b0}
...
.checkout-page .co-field input:focus,.checkout-page .co-field select:focus{outline:2px solid #1773b0;outline-offset:-1px;border-color:#1773b0}
...
.checkout-page input[type=checkbox],.checkout-page input[type=radio]{width:18px;height:18px;accent-color:#1773b0;margin:0;flex-shrink:0}
...
.checkout-page .method:has(input:checked){background:#f0f7fc;box-shadow:inset 0 0 0 1px #1773b0;border-radius:5px}
...
.checkout-page .pay-demo .row{padding:15px 14px;background:#f0f7fc;border-bottom:1px solid #b5b5b5;gap:12px}
...
.checkout-page .pay{margin:2px 0 0;min-height:56px;border:1px solid #1773b0;border-radius:6px;background:#1773b0;color:#fff;font:600 17px/1.3 var(--body);letter-spacing:0;text-transform:none;gap:5px;box-shadow:none}
.checkout-page .pay:hover{background:#105989;border-color:#105989}
...
.checkout-page .co-footer a{color:#1773b0;text-underline-offset:2px}
...
.checkout-page .co-wallet-preview{display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px}.checkout-page .co-wallet-preview button{height:48px;border-radius:5px;border:0;font:500 19px Arial;letter-spacing:-.4px;opacity:1}.checkout-page .co-wallet-apple{background:#000;color:#fff}.checkout-page .co-wallet-google{background:#fff;color:#333;box-shadow:inset 0 0 0 1px #d5d5d5}.checkout-page .co-wallet-google b{color:#4285f4}.checkout-page .co-wallet-link{background:#32df9c;color:#072f23;font-weight:700!important}.checkout-page .co-wallet-link span{margin-left:8px}.checkout-page .co-preview-label{font-size:10px;border:1px solid #d5d5d5;border-radius:3px;padding:2px 4px;margin-left:5px}.checkout-page .co-wallet-help{font-size:11px;color:#626262;text-align:center;margin:8px 0 0;max-width:none}
...
.checkout-page .co-logo{font-size:22px}.checkout-page .co-logo img{max-height:40px;max-width:180px}
...
.checkout-page .co-summary-mobile summary{min-height:64px;align-items:center;font-size:14px;color:#1773b0;gap:12px}
