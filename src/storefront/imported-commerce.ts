...
[data-owned-checkout] .co-field{position:relative!important}[data-owned-checkout] .co-field label{position:absolute!important;left:13px!important;top:5px!important;font:11px/1.3 Arial!important;color:#626262!important;pointer-events:none!important;letter-spacing:0!important;text-transform:none!important}[data-owned-checkout] .co-field input:placeholder-shown:not(:focus)+label{top:15px!important;font-size:14px!important}[data-owned-checkout] .co-field input:not([type=checkbox]):not([type=radio]),[data-owned-checkout] .co-field select{padding:20px 12px 5px!important}[data-owned-checkout] .co-billing[hidden]{display:none!important}[data-owned-checkout] .field-error,[data-owned-checkout] .co-error{color:#b3261e;font-size:13px}[data-owned-checkout] .co-error:empty{display:none}
...
[data-owned-checkout] .field.co-field,[data-owned-checkout-summary] .co-field{position:relative!important}[data-owned-checkout] .co-field input:not([type=checkbox]):not([type=radio]),[data-owned-checkout] .co-field select{padding:20px 12px 5px!important}[data-owned-checkout-summary] .co-field label{position:absolute;top:5px;left:12px;font-size:11px}[data-owned-checkout-summary] .code .co-field{flex:1;min-width:0}[data-owned-checkout-summary] .code input{padding-top:18px!important}
